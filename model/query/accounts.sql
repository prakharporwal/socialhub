...
-- INSERT INTO transactions(transaction_id, from_account_id,to_account_id,amount,currency)
-- VALUES($1,$2,$3,$4,$5)
-- RETURNING *;
--
-- -- name: CreateAccountStatementEntry :one
-- INSERT INTO account_transactions_entries(transaction_id,account_id,other_account, amount, type,currency)
-- VALUES($1,$2,$3,$4,$5,$6)
-- RETURNING *;
