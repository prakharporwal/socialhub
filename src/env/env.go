...
const (
	LINKEDIN_OAUTH_REDIRECT_URL         = "http://localhost:8080/linkedin/oauth/access/callback"
...
const (
	...
	TwitterOAuth2Callback  = "http://localhost:8080/twitter/oauth2/access/callback"
)
