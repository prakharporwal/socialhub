...
type Querier interface {
	...
	PostingHistory_fetchPost(ctx context.Context, limit int32) ([]PostingHistory_fetchPostRow, error)
	PostingHistory_updatePostingStatus(ctx context.Context, arg PostingHistory_updatePostingStatusParams) error
	...
	SocialMediaAccount_fetchAccessToken(ctx context.Context, arg SocialMediaAccount_fetchAccessTokenParams) (SocialMediaAccount_fetchAccessTokenRow, error)
	SocialMediaAccount_upsertAccessToken(ctx context.Context, arg SocialMediaAccount_upsertAccessTokenParams) (SocialMediaAccount_upsertAccessTokenRow, error)
